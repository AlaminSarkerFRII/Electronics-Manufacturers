    ...
    return (
        <>
            <div className="hero  bg-base-200">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <div>
                        ...
                        <p className="py-6">About Product: <br />
            ...
            <div className='mx-auto  w-4/5 lg:w-1/2 mt-8'>
                ...
                <div className="card mx-auto mt-3 p-2 bg-base-100 shadow-xl">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-control mx-auto text-left w-full max-w-xs">
                            ...
                            <input onChange={handleQuantity} placeholder={minOrderQuantity} ref={quantityRef} type="number" name='quantity' id='quantity' className="input input-bordered w-full max-w-xs" />
                        </div>
